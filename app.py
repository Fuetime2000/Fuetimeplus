...
# JWT Configuration - TOKENS NEVER EXPIRE
app.config['JWT_SECRET_KEY'] = app.config['SECRET_KEY']
app.config['JWT_ACCESS_TOKEN_EXPIRES'] = False  # Tokens never expire
app.config['JWT_REFRESH_TOKEN_EXPIRES'] = False  # Tokens never expire
...
# Initialize JWT (Note: JWT is already initialized earlier at line 175, this is duplicate)
# jwt = JWTManager(app)  # COMMENTED OUT - Already initialized at line 175
