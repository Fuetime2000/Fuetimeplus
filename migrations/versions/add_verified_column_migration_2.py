...
Revision ID: add_verified_column_2
Revises: 
...
revision = 'add_verified_column_2'
down_revision = None
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # Update existing records to have verified=True
    op.execute("UPDATE user SET verified = 1 WHERE 1=1")
